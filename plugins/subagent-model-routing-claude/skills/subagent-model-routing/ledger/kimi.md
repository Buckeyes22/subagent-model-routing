...
- **Operational caveats:** subscription-friendly; concurrency-friendly for parallel candidate fan-out; do not sustain >3 concurrent shim calls (502 pressure); streaming + temperature guidance in `prompting/kimi-moonshot-prompting-reference.md`
