...
def build_parser() -> argparse.ArgumentParser:
    ...
    dispatch.add_argument("provider", choices=("codex", "claude", "grok", "kimi", "opencode", "qwen"))
    dispatch.add_argument("provider_args", nargs=argparse.REMAINDER)
    internal = subparsers.add_parser("_shim", add_help=False)
    internal.add_argument("provider", choices=("codex", "claude", "grok", "kimi", "opencode", "qwen"))
    ...
    doctor.add_argument("--provider", choices=("codex", "claude", "grok", "kimi", "opencode", "qwen"))
