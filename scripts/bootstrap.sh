...
#   SUBAGENT_MODEL_ROUTING_REF         release tag/branch (default: "v0.7.1")
...
SUBAGENT_MODEL_ROUTING_REF="${SUBAGENT_MODEL_ROUTING_REF:-v0.7.1}"
while [ "$#" -gt 0 ]; do
  case "$1" in
    --register) REGISTER=1 ;;
    ...
    -h|--help)
      ...
      echo "  --ref                install a specific release tag or branch (default: v0.7.1)"
      exit 0 ;;
